...
BANNER_IMAGES = \
    { 'ashenzari': [ 'banner_ashenzari.png', 'The Explorer' ],
      ...
      'foee': [ 'banner_foee.png', 'FoEE' ],
      'grar': [ 'banner_grar.png', 'GrAr' ],
      'ddbe': [ 'banner_ddbe.png', 'DDBe' ],
      'hewr': [ 'banner_hewr.png', 'HEWr' ],
      'opvm': [ 'banner_opvm.png', 'OpVM' ],
      'tecj': [ 'banner_tecj.png', 'TeCj' ],
      'vsmo': [ 'banner_vsmo.png', 'VSMo' ],
...
BANNER_TEXT = \
    { 'ashenzari':
      ...
      'ddbe':
        [ 'Get a Rune during DDBe challenge!',
          'Get a Win during DDBe challenge!!',
          'Get the Highest MFC Score during DDBe challenge!!!',
        ],
      'hewr':
        [ 'Get a Rune during HEWr challenge!',
          'Get a Win during HEWr challenge!!',
          'Get the Highest MFC Score during HEWr challenge!!!',
        ],
      'opvm':
        [ 'Get a Rune during OpVM challenge!',
          'Get a Win during OpVM challenge!!',
          'Get the Highest MFC Score during OpVM challenge!!!',
        ],
      'tecj':
        [ 'Get a Rune during TeCj challenge!',
          'Get a Win during TeCj challenge!!',
          'Get the Highest MFC Score during TeCj challenge!!!',
        ],
      'vsmo':
        [ 'Get a Rune during VSMo challenge!',
          'Get a Win during VSMo challenge!!',
          'Get the Highest MFC Score during VSMo challenge!!!',
        ],
      '1top_player':
